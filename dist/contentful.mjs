var L = Function.prototype.toString, m = Object.create, E = Object.defineProperty, C = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, k = Object.getOwnPropertySymbols, M = Object.getPrototypeOf, S = Object.prototype, B = S.hasOwnProperty, R = S.propertyIsEnumerable, _ = typeof k == "function", T = typeof WeakMap == "function", j = function() {
  if (T)
    return function() {
...
const y = (e) => {
  ...
  meta: {
    pagination: {
      ...
      hasNextPage: e.skip * e.limit < e.total,
      hasPrevPage: e.skip > 0
    }
  },
  data: X(y(e))
});
